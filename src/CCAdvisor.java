...
//Class:       CCAdvisor
//Description: Digital representation of an Advisor piece
...
/**
 * Digital representation of an Advisor piece.
 */
public class CCAdvisor implements CCPieces
{
    /** value of the piece */
     ...
     */
    public CCAdvisor (CCPieces board[] [], boolean playerOne, int x, int y)
    {
	...
	if (playerOne)
	{
	    icon = new JLabel (new ImageIcon (getClass ().getResource ("images/AdvisorRed.png")));
	    PIECE_TYPE = CCPieces.ADVISOR1;
	}
	else
	{
	    icon = new JLabel (new ImageIcon (getClass ().getResource ("images/AdvisorGreen.png")));
	    PIECE_TYPE = CCPieces.ADVISOR2;
	}
