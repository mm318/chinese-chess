...
//Class:       CCChariot
//Description: Digital representation of a Chariot piece
...
/**
 * Digital representation of a Chariot piece.
 */
public class CCChariot implements CCPieces
{
    /** value of the piece */
    private int PIECE_VALUE = 9;
    /** type of piece */
     ...
     */
    public CCChariot (CCPieces board[] [], boolean playerOne, int x, int y)
    {
	...
	if (playerOne)
	{
	    icon = new JLabel (new ImageIcon (getClass ().getResource ("images/ChariotRed.png")));
	    PIECE_TYPE = CCPieces.CHARIOT1;
	}
	else
	{
	    icon = new JLabel (new ImageIcon (getClass ().getResource ("images/ChariotGreen.png")));
	    PIECE_TYPE = CCPieces.CHARIOT2;
	}
	...
	if (board [y2] [x2] != null && isPlayerOne == board [y2] [x2].isPlayerOne ())
	    return false;
